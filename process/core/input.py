...
INPUT_VARIABLES = {
    ...
    "i_cp_shield_material": InputVariable("fwbs", int, choices=[0, 1, 2]),
    "f_cp_shield_material_heat": InputVariable("fwbs", float, range=(0.01, 1.0)),
    "f_cp_shield_material_flux": InputVariable("fwbs", float, range=(0.01, 1.0)),
